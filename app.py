...
def analyze_document(text):
    ...
    ⚠️ กฎการพิมพ์รายงาน:
    - ให้ขึ้นต้นรายงานบรรทัดแรกสุดด้วยข้อความว่า "**ถึง นิสิตผู้รับผิดชอบโครงการ**" เสมอ (ห้ามใช้คำว่า "เรียน...") 
    - จากนั้นให้เกริ่นนำสั้นๆ แล้วจัดเรียงลำดับการรายงานผลตามนี้:
