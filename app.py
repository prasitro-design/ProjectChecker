...
⚠️ กฎการพิมพ์รายงาน (สำคัญมาก):
    ...
    **🚨 กฎเหล็กสำหรับการตรวจส่วนที่ 1 (Strict Rules):**
    ...
    13. ความสอดคล้องกับการพัฒนานิสิต (บังคับ: ต้องมีการระบุครบทั้ง 7 อย่าง คือ 1.การพัฒนานิสิตตามกรอบมาตรฐานคุณวุฒิระดับอุดมศึกษาของประเทศไทย 4 ด้าน, 2.อัตลักษณ์ มก., 3.การพัฒนานิสิตตามวิสัยทัศน์ของคณะศึกษาศาสตร์, 4.SDGs, 5.กิจกรรมพัฒนาผู้เรียนตามหลักเกณฑ์การรับรองปริญญาและประกาศนียบัตรทางการศึกษาของคุรุสภา และ 6.สมรรถนะ 8 ด้าน หากขาดข้อใดข้อหนึ่งไป ให้ประเมินเป็น 🟡 ทันที)
...
with st.sidebar:
    ...
    **ขั้นตอนการตรวจเอกสาร:**
    1. บันทึกไฟล์โครงการเป็นนามสกุล **.pdf** 
       *(ต้องเป็นไฟล์ที่แปลงจาก MS Word เท่านั้น!)*
    2. อัปโหลดไฟล์และกดยอมรับเงื่อนไข
    3. กดปุ่ม **เริ่มให้ AI ตรวจสอบและให้คะแนน**
    """)
        ...
        if pdpa_consent:
            if st.button("🚀 เริ่มให้ AI ตรวจสอบเอกสารโครงการ"):
                ...
                if result:
                    ...
                    st.info("⚠️ **หมายเหตุ:** การประเมินนี้วิเคราะห์โดยปัญญาประดิษฐ์ (AI) เพื่อใช้เป็นแนวทางในการปรับปรุงเอกสารเบื้องต้นเท่านั้น **การพิจารณาอนุมัติโครงการขั้นสุดท้ายจะขึ้นอยู่กับดุลยพินิจของอาจารย์ที่ปรึกษาและคณะกรรมการฝ่ายพัฒนานิสิต**")
