        ...
        if pdpa_consent:
            if st.button("🚀 เริ่มให้ AI ตรวจสอบเอกสารโครงการ"):
                ...
                if result:
                    ...
                    st.info("⚠️ **หมายเหตุ:** การประเมินนี้วิเคราะห์โดยปัญญาประดิษฐ์ (AI) เพื่อใช้เป็นแนวทางในการปรับปรุงเอกสารเบื้องต้นเท่านั้น **การพิจารณาอนุมัติโครงการจะขึ้นอยู่กับดุลยพินิจของคณะกรรมการฝ่ายพัฒนานิสิตและคณบดีคณะศึกษาศาสตร์**")
