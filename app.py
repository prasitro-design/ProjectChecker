...
<div class="header-box">
    ...
    <div class="subtitle-text">
        ✨ ระบบการตรวจสอบโครงสร้าง การสะกดคำ และความสมเหตุสมผลของโครงการจาก AI เป็นเพียงการคัดกรองเบื้องต้นเพื่อช่วยลดข้อผิดพลาดก่อนนำเสนอคณะกรรมการฝ่ายพัฒนานิสิตเท่านั้น
    </div>
</div>
""", unsafe_allow_html=True)
